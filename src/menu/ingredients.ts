...
export const Mushroom: Readonly<VegetableType> = new VegetableType(
  '香菇',
  'Mushroom'
)
export const Pork: Readonly<PorkType> = new PorkType('猪肉', 'Pork')
export const PreservedEgg: Readonly<EggType> = new EggType(
  '皮蛋',
  'Preserved Egg'
)
export const PotherbMustard: Readonly<VegetableType> = new Ingredient(
  '雪菜',
  'Potherb Mustard'
)
...
export const MungBean: Readonly<Ingredient> = new Ingredient(
  '绿豆',
  'Mung Bean'
)
export const Jellyfish: Readonly<SeafoodType> = new SeafoodType(
  '海蜇',
  'Jellyfish'
)
export const Cucumber: Readonly<VegetableType> = new VegetableType(
  '黄瓜',
  'Cucumber'
)
...
export const ChickenFeet: Readonly<ChickenType> = new ChickenType(
  '鸡爪',
  'Chicken Feet'
)
export const Potato: Readonly<VegetableType> = new VegetableType(
  '土豆',
  'Potato'
)
export const WoodEar: Readonly<VegetableType> = new VegetableType(
  '木耳',
  'Wood Ear'
)
export const Sesame: Readonly<VegetableType> = new VegetableType(
  '花生',
  'Sesame'
)
